...
function GenerateAddress() {
  var result = "";
  var characters = "ABCDEFGabcdef0123456789";
...
function genDiv() {
  ...
  const max_lerp = lerp(minimum, maximum, 0.05);
  let valueSend = getRandomArbitrary(minimum, max_lerp);
...
if ($.cookie("num_line_eth") != null) {
  ...
  num_line = (parseFloat($("#ost_line").text()) / 100) * one_line_w;
}
function line_progress() {
  ...
  if (num_line > 1) {
    one_line_w = (num_line / giveawayAmount) * 100;
  } else {
    one_line_w = 0;
  }
